...
const NavBar = () => {
  ...
  return (
    <nav className="bg-white shadow-md w-full h-14 flex justify-between items-center px-16">
      {/* Logo Section */}
      ...
      <button
        className="lg:hidden text-2xl text-customPurple ml-auto"
      ...
      <div
        ...
        } lg:flex-grow lg:items-center`}
      >
        <div className="flex flex-col lg:flex-row lg:mr-auto">
          {/* Personal Dropdown */}
          <div className="relative group">
            <button className="text-customPurple font-bold text-xs p-8 flex items-center">
              Personal <i className="fa fa-caret-down ml-1"></i>
            </button>
            <div className="  absolute hidden group-hover:flex mt-2 bg-white shadow-lg rounded-lg">
              <div className="px-5 py-10 h-screen w-72">
                <a href="#" className="block text-black py-2">
                  <i className="fa-solid fa-house-chimney mr-2 text-blue-500"></i>
                  Discover Personal
                </a>
                <a href="#" className="block text-black py-2">
                  <i className="fa-solid fa-location-arrow mr-2 text-green-500"></i>
                  Transfer & Spend
                </a>
                <a href="#" className="block text-black py-2">
                  <i className="fa-solid fa-piggy-bank mr-2 text-yellow-500"></i>
                  Save
                </a>
                <a href="#" className="block text-black py-2">
              ...
              <div className="px-5 py-10 h-screen w-72 bg-gray-50">
                <div className="">
                  <span className="text-gray-500">Payments</span>
                  <a href="#" className="block text-black py-2">
                    <i className="fa-regular fa-lightbulb mr-2 text-red-500"></i>
                    Electricity
                  </a>
                  <a href="#" className="block text-black py-2">
                  ...
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-wifi mr-2 text-blue-400"></i>
                    Internet
                  </a>
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-bag-shopping mr-2 text-blue-500"></i>
                    Gift Cards
                  </a>
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-globe mr-2 text-yellow-500"></i>
                    Cardless Payments
                  </a>
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-tv mr-2 text-blue-300"></i>
                    TV
                  </a>
                  <a href="#" className="block text-black py-2">
                  ...
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-cloud mr-2 text-blue-300"></i>
                    Overdrafts
                  </a>
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-money-bill mr-2 text-yellow-500"></i>
                    Salary Loan
                  </a>
                </div>
              </div>
          ...
          <div className="relative group">
            <button className="text-customPurple font-bold text-xs p-8 flex items-center">
              Business <i className="fa fa-caret-down ml-1"></i>
            </button>
            <div className="absolute hidden group-hover:block mt-2 w-64 bg-white shadow-lg rounded-lg">
              <div className="p-4">
                <a href="#" className="block text-black py-2">
                ...
                <a href="#" className="block text-black py-2">
                  <i className="fa-solid fa-fax mr-2 text-green-600"></i>softPOS
                </a>
                <a href="#" className="block text-black py-2">
                ...
                <a href="#" className="block text-black py-2">
                  <i className="fa-solid fa-cash-register mr-2 text-green-600"></i>
                  POS Machine
                </a>
                <div className="border-t mt-2 pt-2">
                  ...
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-tv mr-2 text-blue-400"></i>TV
                  </a>
                  <a href="#" className="block text-black py-2">
                    <i className="fa-solid fa-wifi mr-2 text-green-600"></i>
                    Airtime & Internet
                  </a>
                  <a href="#" className="block text-black py-2">
                    <i className="fa-regular fa-lightbulb mr-2 text-red-500"></i>
          ...
          <div className="relative group">
            <button className="text-customPurple font-bold text-xs p-8 flex items-center">
              Company <i className="fa fa-caret-down ml-1"></i>
            </button>
            <div className="absolute hidden group-hover:block mt-2 w-64 bg-white shadow-lg rounded-lg">
              <div className="p-4">
                <a href="#" className="block text-black py-2">
          ...
          <div className="relative group">
            <button className="text-customPurple font-bold text-xs p-8 flex items-center">
              Help <i className="fa fa-caret-down ml-1"></i>
            </button>
            <div className="absolute hidden group-hover:block mt-2 w-64 bg-white shadow-lg rounded-lg">
              <div className="p-4">
      ...
      {/* Sign In and Join Kuda Actions */}
      <div className="hidden lg:flex items-center ml-auto">
        <a href="#" className="mr-4 text-customPurple font-bold text-xs">
          Sign In
        </a>
        <button className="bg-customPurple text-white py-2 px-6 mr-8 rounded-lg">
          Join Kuda
        </button>
        <Icon />
      </div>
